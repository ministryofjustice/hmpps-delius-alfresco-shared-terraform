        ...
        stage('setup') {
            steps {
                ...
                dir( project.alfresco ) {
                  git url: 'git@github.com:ministryofjustice/' + project.alfresco, branch: 'name_too_long_fix_delius_training_test', credentialsId: 'f44bc5f1-30bd-4ab9-ad61-cc32caf1562a'
                }
