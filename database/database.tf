...
module "database" {
  ...
  engine                          = local.engine
  engine_version                  = "11.22" # Latest minor version at time of writing - see https://docs.aws.amazon.com/AmazonRDS/latest/PostgreSQLReleaseNotes/postgresql-release-calendar.html
