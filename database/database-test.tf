...
module "database2" {
  ...
  engine                          = local.engine
  engine_version                  = "11.4" #local.master_engine_version
  final_snapshot_identifier       = "alfresco-database-final-snapshot-test"
  identifier                      = "alfresco-database2"
  ...
  name                            = local.db_name
  option_group_name               = "default:postgres-11" #module.db_option_group.db_option_group_id
  parameter_group_name            = "default.postgres11"  #module.parameter_group.db_parameter_group_id
